...
from network.PointNet import PointNet
from network.SamplerNet import SamplerNet
...
# Load in
all_files1 = np.load('../feature_Feb28_vgg_z.npy')
all_files2 = np.load('../feature_ptnet_Feb28_lastlayer_z.npy')
all_forces = np.load('../grd_Feb28_vgg_z.npy')
...
# Construct the model
ptnet_model_pretrained_file = '../pt_net_00041.pt'
snet = SamplerNet(ptnet_model_pretrained_file, n_frames, nbatch)
snet.cuda()
